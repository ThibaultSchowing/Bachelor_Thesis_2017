...
%TODO citer Hastie (pdf)

Random Forest effectue donc un apprentissage sur de multiples arbres de décision entraînés sur des sous-ensembles de données légèrement différents.

%TODO citer https://www.stat.berkeley.edu/~breiman/randomforest2001.pdf
%TODO citer http://blog.octo.com/les-methodes-ensemblistes-pour-algorithmes-de-machine-learning/
