...
\noindent Les données concernant le café sont aussi très différentes une fois leurs dimensions réduites comme on peut le voir sur la figure \ref{PCA_Coffee_Output1}. 

\begin{figure}[H]
	\includegraphics[scale=0.7]{PCA_Coffee_Output1}
	\caption{\label{PCA_Coffee_Output1} PCA des sorties, c'est-à-dire des données de dégustation et des défauts physiques du café.}
\end{figure}

\noindent Si on ne regarde que les points nous obtenons une répartition comme sur la figure \ref{PCA_Coffee_Output2}.
\begin{figure}[H]
	\includegraphics[scale=0.7]{PCA_Coffee_Output2}
	\caption{\label{PCA_Coffee_Output2} PCA des résultats de dégustation du café.}
\end{figure}
