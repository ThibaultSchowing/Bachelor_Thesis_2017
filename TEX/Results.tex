...
\begin{figure}[H]
	\caption{Températures et autres données environnementales}
	\centering
...
On peut observer que les régions avec beaucoup de précipitations sont aussi celles qui ont le plus de cafés avec peu de points. 
