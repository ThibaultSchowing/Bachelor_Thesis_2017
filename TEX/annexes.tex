...
%TODO -> pas si important que ça dans le rapport, ona déjà des résultats

%
%\begin{figure}[H]
%	\caption{Partial Plots}
%	\centering
%	\subfloat[]{\includegraphics[width=.3\linewidth]{PPlots/}}\hfill
%	\subfloat[]{\includegraphics[width=.3\linewidth]{PPlots/}}\hfill
%	\subfloat[]{\includegraphics[width=.3\linewidth]{PPlots/}}
%	\newline
%	\subfloat[]{\includegraphics[width=.3\linewidth]{PPlots/}}\hfill
%	\subfloat[]{\includegraphics[width=.3\linewidth]{PPlots/}}\hfill
%	\subfloat[]{\includegraphics[width=.3\linewidth]{PPlots/}}
